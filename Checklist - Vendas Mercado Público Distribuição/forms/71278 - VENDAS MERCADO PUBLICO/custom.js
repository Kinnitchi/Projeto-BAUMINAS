		...
		success: function (dataset) {
			...
			$("button[data-open-modal]").click(function (event) {
				...
				if (tipo == "ALTERACAO") {
					...
					const alteracao = DatasetFactory.getDataset(
					...
					if (alteracao.values.length > 0) {
						...
						const values = alteracao.values[0];
						...
						const values2 = dsAlteracao.values[0];

						if (alteracao2.values.length > 0) {

							if (values2.oldFluig == null || values2.oldFluig == undefined || values2.oldFluig == "") {
								fluig = values2.numeroFluig;
								console.log("NUMERO FLUIG: " + values2.numeroFluig + " - FLUIG: " + fluig + " - OLD FLUIG: " + values2.oldFluig);
							} else {
								fluig = values2.oldFluig;
								console.log("OLDFLUIG: " + values2.oldFluig + " - NUMEROFLUIG: " + values2.numeroFluig + " - FLUIG: " + fluig);
							}

							values2.codigoCliente ? $("#TXT_CodigoCliente").val(values2.codigoCliente) : $("#TXT_CodigoCliente").val("");
							values2.cnpj ? $("#TXT_CNPJ").val(values2.cnpj) : $("#TXT_CNPJ").val("");
							values2.razaoSocial ? $("#TXT_Cliente").val(values2.razaoSocial) : $("#TXT_Cliente").val("");
							values2.contratoAta ? $("#TXT_ContratoAta").val(values2.contratoAta) : $("#TXT_ContratoAta").val("");
							values2.numEditEmp ? $("#TXT_NumEditEmp").val(values2.numEditEmp) : $("#TXT_NumEditEmp").val("");
							values2.numPedidoContrato ? $("#TXT_PedContr").val(values2.numPedidoContrato) : $("#TXT_PedContr").val("");
							values2.ateZerarSaldo ? $("#Rd_ZerarSd").val(values2.ateZerarSaldo) : $("#Rd_ZerarSd").val("");
							values2.vigenciaContratoIni ? $("#DT_ContratoDe").val(values2.vigenciaContratoIni) : $("#DT_ContratoDe").val("");
							values2.vigenciaContratoFim ? $("#DT_ContratoAte").val(values2.vigenciaContratoFim) : $("#DT_ContratoAte").val("");
							values2.unidadeFaturamento ? $("#CMB_UnidFaturam").val(values2.unidadeFaturamento) : $("#CMB_UnidFaturam").val("");
							values2.unidadeOrigem ? $("#CMB_UnidOrigem").val(values2.unidadeOrigem) : $("#CMB_UnidOrigem").val("");
							values2.produtoBauminas ? $("#CMB_Produto").val(values2.produtoBauminas) : $("#CMB_Produto").val("");
							values2.produtoBauminas ? $("#CMB_Produto").val(values2.produtoBauminas) : $("#CMB_Produto").val("");
							values2.produtoAmbientaly ? $("#txt_ProdAmb").val(values2.produtoAmbientaly) : $("#txt_ProdAmb").val("");
							values2.codigoProduto ? $("#TXT_CodProd").val(values2.codigoProduto) : $("#TXT_CodProd").val("");
							values2.qtdeLicitKg ? $("#qtdeLicitKg").val(values2.qtdeLicitKg) : $("#qtdeLicitKg").val("");
							values2.qtdeLicitTon ? $("#qtdeLicitTon").val(values2.qtdeLicitTon) : $("#qtdeLicitTon").val("");
							values2.qtdeLicitLitros ? $("#qtdeLicitLitros").val(values2.qtdeLicitLitros) : $("#qtdeLicitLitros").val("");
							values2.qtdeLicitBaseSeca ? $("#qtdeLicitBaseSeca").val(values2.qtdeLicitBaseSeca) : $("#qtdeLicitBaseSeca").val("");
							values2.qtdeLicitM3 ? $("#qtdeLicitM3").val(values2.qtdeLicitM3) : $("#qtdeLicitM3").val("");
							values2.qtdeTotalKg ? $("#qtdeTotalKg").val(values2.qtdeTotalKg) : $("#qtdeTotalKg").val("");
							values2.qtdeTotalTon ? $("#qtdeTotalTon").val(values2.qtdeTotalTon) : $("#qtdeTotalTon").val("");
							values2.qtdeTotalLitros ? $("#qtdeTotalLitros").val(values2.qtdeTotalLitros) : $("#qtdeTotalLitros").val("");
							values2.qtdeTotalBaseSeca ? $("#qtdeTotalBaseSeca").val(values2.qtdeTotalBaseSeca) : $("#qtdeTotalBaseSeca").val("");
							values2.qtdeTotalM3 ? $("#qtdeTotalM3").val(values2.qtdeTotalM3) : $("#qtdeTotalM3").val("");
							values2.qtdeFinalKg ? $("#precoFinalKg").val(values2.precoFinalKg) : $("#precoFinalKg").val("");
							values2.qtdeFinalTon ? $("#precoFinalTon").val(values2.precoFinalTon) : $("#precoFinalTon").val("");
							values2.qtdeFinalLitros ? $("#precoFinalLitros").val(values2.precoFinalLitros) : $("#precoFinalLitros").val("");
							values2.precoFinalBaseSeca ? $("#precoFinalBaseSeca").val(values2.precoFinalBaseSeca) : $("#precoFinalBaseSeca").val("");
							values2.precoFinalM3 ? $("#precoFinalM3").val(values2.precoFinalM3) : $("#precoFinalM3").val("");
							values2.condicaoPagamento ? $("#TXT_CondPg").val(values2.condicaoPagamento) : $("#TXT_CondPg").val("");
							values2.prazoEntrega ? $("#radio35").val(values2.prazoEntrega) : $("#radio35").val("");
							values2.especificarDias ? $("#TXT_PrazoEntreg").val(values2.prazoEntrega) : $("#TXT_PrazoEntreg").val("");
							values2.tipoFrete ? $("#CMB_TipoFrete").val(values2.tipoFrete) : $("#CMB_TipoFrete").val("");
							values2.valorFrete ? $("#TXT_Valor").val(values2.valorFrete) : $("#TXT_Valor").val("");
							values2.seRedespacho ? $("#PAR_SERED").val(values2.seRedespacho) : $("#PAR_SERED").val("");
							values2.tipoEntrega1 ? $("#sel_tipoEntrega0").prop("checked", true) : $("#sel_tipoEntrega0").prop("checked", false);
							values2.tipoEntrega2 ? $("#sel_tipoEntrega1").prop("checked", true) : $("#sel_tipoEntrega1").prop("checked", false);
							values2.tipoEntrega3 ? $("#sel_tipoEntrega2").prop("checked", true) : $("#sel_tipoEntrega2").prop("checked", false);
							values2.tipoEntrega4 ? $("#sel_tipoEntrega3").prop("checked", true) : $("#sel_tipoEntrega3").prop("checked", false);
							values2.tipoEntrega5 ? $("#sel_tipoEntrega4").prop("checked", true) : $("#sel_tipoEntrega4").prop("checked", false);
							values2.tipoEntrega6 ? $("#sel_tipoEntrega5").prop("checked", true) : $("#sel_tipoEntrega5").prop("checked", false);
							values2.tipoEntrega7 ? $("#sel_tipoEntrega6").prop("checked", true) : $("#sel_tipoEntrega6").prop("checked", false);
							values2.tipoEntrega8 ? $("#sel_tipoEntrega7").prop("checked", true) : $("#sel_tipoEntrega7").prop("checked", false);
							values2.tipoEntrega9 ? $("#sel_tipoEntrega8").prop("checked", true) : $("#sel_tipoEntrega8").prop("checked", false);
							values2.tipoEntrega10 ? $("#sel_tipoEntrega9").prop("checked", true) : $("#sel_tipoEntrega9").prop("checked", false);
							values2.tipoEntrega11 ? $("#sel_tipoEntrega10").prop("checked", true) : $("#sel_tipoEntrega10").prop("checked", false);
							values2.tipoEntrega12 ? $("#sel_tipoEntrega11").prop("checked", true) : $("#sel_tipoEntrega11").prop("checked", false);
							values2.tipoEntrega13 ? $("#sel_tipoEntrega12").prop("checked", true) : $("#sel_tipoEntrega12").prop("checked", false);
							values2.tipoEntrega14 ? $("#sel_tipoEntrega13").prop("checked", true) : $("#sel_tipoEntrega13").prop("checked", false);
							values2.tipoEntrega15 ? $("#sel_tipoEntrega14").prop("checked", true) : $("#sel_tipoEntrega14").prop("checked", false);
							values2.tipoEntrega16 ? $("#sel_tipoEntrega15").prop("checked", true) : $("#sel_tipoEntrega15").prop("checked", false);
							values2.tipoEntrega17 ? $("#sel_tipoEntrega16").prop("checked", true) : $("#sel_tipoEntrega16").prop("checked", false);
							values2.tipoEntrega18 ? $("#sel_tipoEntrega17").prop("checked", true) : $("#sel_tipoEntrega17").prop("checked", false);
							values2.tipoEntrega19 ? $("#sel_tipoEntrega18").prop("checked", true) : $("#sel_tipoEntrega18").prop("checked", false);
							values2.tipoEntrega20 ? $("#sel_tipoEntrega19").prop("checked", true) : $("#sel_tipoEntrega19").prop("checked", false);
							values2.horarioRecebimento ? $("#TXT_HrReb").val(values2.horarioRecebimento) : $("#TXT_HrReb").val("");
							values2.optPaletizado ? $("#checkbox41opc0").prop("checked", true) : $("#checkbox41opc0").prop("checked", false);
							values2.optFilmado ? $("#checkbox41opc1").prop("checked", true) : $("#checkbox41opc1").prop("checked", false);
							values2.optCargaBatida ? $("#checkbox41opc2").prop("checked", true) : $("#checkbox41opc2").prop("checked", false);
							values2.optDemandaAjudante ? $("#checkbox41opc3").prop("checked", true) : $("#checkbox41opc3").prop("checked", false);
							values2.optExigeLogReversa ? $("#checkbox41opc4").prop("checked", true) : $("#checkbox41opc4").prop("checked", false);
							values2.optDemandaContratEmpilh ? $("#checkbox41opc5").prop("checked", true) : $("#checkbox41opc5").prop("checked", false);
							values2.mangote ? $("#Rd_Mangote").val(values2.mangote) : $("#Rd_Mangote").val("");
							values2.tamanho ? $("#TXT_MangMetros").val(values2.tamanho) : $("#TXT_MangMetros").val("");
							values2.bomba ? $("#Rd_Bomba").val(values2.bomba) : $("#Rd_Bomba").val("");
							values2.engate ? $("#Rd_Engate").val(values2.engate) : $("#Rd_Engate").val("");
							values2.especPolegadas ? $("#TXT_Polegadas").val(values2.especPolegadas) : $("#TXT_Polegadas").val("");
							values2.obsParaLogistica ? $("#PAR_ObsLogistic").val(values2.obsParaLogistica) : $("#PAR_ObsLogistic").val("");
							values2.especificacaoProduto ? $("#TXT_EspProd").val(values2.especificacaoProduto) : $("#TXT_EspProd").val("");
							values2.envioLaudosEspecificos ? $("#TXT_LaudoEsp").val(values2.envioLaudosEspecificos) : $("#TXT_LaudoEsp").val("");
							values2.demandaEquip ? $("#Rd_DemEquip").val(values2.demandaEquip) : $("#Rd_DemEquip").val("");
							values2.especificarEquip ? $("#TXT_EspEquip").val(values2.especificarEquip) : $("#TXT_EspEquip").val("");
							values2.obsLicitacoes ? $("#PAR_OBSAREALICT").val(values2.obsLicitacoes) : $("#PAR_OBSAREALICT").val("");
							values2.obsAtendimentoClientes ? $("#obsAtendimentoClientes").val(values2.obsAtendimentoClientes) : $("#obsAtendimentoClientes").val("");
