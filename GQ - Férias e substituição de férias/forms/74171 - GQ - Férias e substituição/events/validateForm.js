function validateForm(form) {
    ...
    if (atividadeAtual == 0 || atividadeAtual == 1 || atividadeAtual == "") {
        ...
        txtErro += form.getValue("rad_diretoriaDeAcordo") == null || form.getValue("rad_diretoriaDeAcordo") == undefined || form.getValue("rad_diretoriaDeAcordo") == "" ? "<br>Aprovado" : "";

        if (form.getValue("rad_diretoriaDeAcordo") == "Nao") {
